...
**Documentation (`docs/`):**
- **course.md**: A 30-day course outline
- **course_expanded.md**: A more detailed outline with code snippets resources a and tasks. Not in complete syn with course.md
...
1. **Prefer TypeScript** for all new files with comprehensive typing.
